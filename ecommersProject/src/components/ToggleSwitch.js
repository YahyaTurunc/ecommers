...
const ToggleSwitch = () => {
  const [darkMode, setDarkMode] = useState(() => {
    // İlk yüklemede localStorage'daki değeri kullan
  ...
  return (
    <label className="inline-flex items-center relative">
      ...
      />
      <div
        className="relative w-[70px] h-[35px] bg-white peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[25px] after:h-[25px] after:bg-gradient-to-r from-blue-700 to-gray-200 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[30px] peer-checked:after:left-[65px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
      ></div>
      <svg
        height="0"
        width="100"
